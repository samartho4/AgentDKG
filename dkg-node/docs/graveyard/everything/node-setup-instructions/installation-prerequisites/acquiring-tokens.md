...
In order to acquire testnet tokens for the above listed blockchains, please refer to OriginTrail's Discord Faucet usage [instructions](../../../../dkg-knowledge-hub/useful-resources/test-token-faucet.md).
