...
**Learn more on** [**Protocol updates here**](../../dkg-knowledge-hub/learn-more/previous-updates/dkg-v8.0-update-guidebook/protocol-updates.md)

**Learn more on the upcoming** [**Feature roadmap**](../../dkg-knowledge-hub/learn-more/previous-updates/dkg-v8.0-update-guidebook/feature-roadmap.md) **here**

To understand what you need to **do to upgrade your applications or nodes**, head over to the "[How to upgrade to V8](../../dkg-knowledge-hub/learn-more/previous-updates/dkg-v8.0-update-guidebook/how-to-upgrade-to-v8.md)" page
